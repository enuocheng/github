...
![](https://assets.2dfire.com/frontend/c9ce609931899b85971ac7de30a39dc2.png)   
...
一个是setChanged()，另一个是notifyObservers()。第一方法setChanged()被调用之后会设置一个内部标记变量，代表被观察者对象的状态发生了变化。
